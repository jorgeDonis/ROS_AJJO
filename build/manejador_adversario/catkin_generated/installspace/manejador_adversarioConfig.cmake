...
if("FALSE" STREQUAL "TRUE")
  ...
  set(manejador_adversario_DEVEL_PREFIX /home/jorge/catkin_ws/devel)
  ...
  set(manejador_adversario_INSTALL_PREFIX /home/jorge/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manejador_adversario' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
